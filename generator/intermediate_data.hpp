...
{
public:
  OSMElementSqliteCacheReader(std::string const & name, bool preload = false);
...
// Sqlite
class SqlitePointStorageReader
{
public:
  explicit SqlitePointStorageReader(std::string const & name);
...
class SqlitePointStorageWriter
{
public:
  explicit SqlitePointStorageWriter(std::string const & name);
